<template>
  <div>
    ...
    <div>
      ...
      <div
        class="-mx-4 mt-4 border dark:border-slate-900 ring-1 ring-black ring-opacity-5 rounded sm:-mx-6 md:mx-0"
      >
        <table class="min-w-full">
          ...
          <tbody
            class="tbody-class divide-y divide-gray-200 dark:divide-slate-900 bg-white dark:bg-slate-800"
          >
    ...
    <div v-if="!resources && !props.relation" class="bg-gray-50 rounded py-4">
      <EmptyImage class="w-1/3 mx-auto h-64 mt-4" />
      <p class="font-semibold text-gray-500 text-center my-4">Il n'y a rien ici</p>
    </div>
    <div v-if="!$slots['table-body'] && props.relation" class="bg-gray-50 rounded py-4">
      <EmptyImage class="w-1/3 mx-auto h-64 mt-4" />
      <p class="font-semibold text-gray-500 text-center my-4">Il n'y a rien ici</p>
    </div>
